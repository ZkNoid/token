...
const SRC = 'https://www.zknoid.io/';
const DECIMALS = 9n;
/** The max supply of the token. */
const SUPPLY = UInt64.from(1_000_000_000n * 10n ** DECIMALS);

export class ZkNoidTokenContract extends TokenContract implements FungibleTokenLike {
  decimals = UInt64.from(DECIMALS)
